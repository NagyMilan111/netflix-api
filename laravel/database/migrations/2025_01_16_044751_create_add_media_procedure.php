...
// database/migrations/xxxx_xx_00_create_add_media_procedure.php
use Illuminate\Database\Migrations\Migration;
use Illuminate\Support\Facades\DB;

class CreateAddMediaProcedure extends Migration
{
    public function up()
    {
        DB::unprepared('
    ...
    {
        DB::unprepared('DROP PROCEDURE IF EXISTS add_media');
    }
}
