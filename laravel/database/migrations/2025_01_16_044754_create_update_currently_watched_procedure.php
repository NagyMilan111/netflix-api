...
// database/migrations/xxxx_xx_00_create_update_currently_watched_procedure.php
use Illuminate\Database\Migrations\Migration;
use Illuminate\Support\Facades\DB;

class CreateUpdateCurrentlyWatchedProcedure extends Migration
{
    public function up()
    {
        DB::unprepared('
    ...
    {
        DB::unprepared('DROP PROCEDURE IF EXISTS update_currently_watched');
    }
}