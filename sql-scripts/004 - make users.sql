...
CREATE USER IF NOT EXISTS 'senior'@'%' IDENTIFIED BY 'password';
GRANT CREATE, ALTER, DROP, INSERT, 
UPDATE, DELETE, SELECT, INDEX ON Netflix.* TO 'senior'@'%';
...
CREATE USER IF NOT EXISTS 'medior'@'%' IDENTIFIED BY 'password';
...
CREATE USER IF NOT EXISTS 'junior'@'%' IDENTIFIED BY 'password';
GRANT SELECT ON Netflix.Genre TO 'medior'@'%';
GRANT SELECT ON Netflix.Language TO 'medior'@'%';
GRANT SELECT ON Netflix.Media TO 'medior'@'%';
GRANT SELECT ON Netflix.Media_Quality TO 'medior'@'%';
...
CREATE USER IF NOT EXISTS 'api'@'%' IDENTIFIED BY 'password';
